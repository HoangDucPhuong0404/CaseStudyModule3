...
<body>
    ...
    <div class="container tm-mt-big tm-mb-big" style="background-color: lightsalmon">
        <div class="row">
                            ...
                            <form class="tm-edit-product-form" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="custom-select tm-select-accounts" id="category" name="category">
                                        <option value="1">Concantrate</option>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                        <label for="expire_date">Made In
                                        </label>
                                        <input id="expire_date" name="madein" type="text" class="form-control validate"
                                            data-large-mode="true" />
                                    </div>
                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                        <label for="expire_date">Weight
                                        </label>
                                        <input id="weight" name="weight" type="number" class="form-control validate"
                                            data-large-mode="true" />
                                    </div>
                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                        ...
                                        <input id="stock" name="quantity" type="number" class="form-control validate"
                                            required />
                                    </div>
                                </div>
    ...
    <footer class="tm-footer row tm-mt-small">
        <div class="col-12 font-weight-light">
            <p class="text-center text-white mb-0 px-4 small">
                ...
                Design: <a rel="nofollow noopener" href="https://templatemo.com" class="tm-footer-link">Sico's Boss</a>
            </p>
        </div>
    </footer>
